...
static int16_t I2C2_flowsensor_BUF[2];
...
float getFlowrate()
{
	HAL_I2C_Master_Receive(&hi2c2,0x92,(uint8_t *)I2C2_flowsensor_BUF,2,1);
	I2C2_flowsensor_BUF[1]=__SWAP16(I2C2_flowsensor_BUF[0]);
	return 100*(I2C2_flowsensor_BUF[1]/16384.0f-0.1f)/0.8f;
}
